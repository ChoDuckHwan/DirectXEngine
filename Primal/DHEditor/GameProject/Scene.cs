...
namespace DHEditor.GameProject
{
    ...
    class Scene : ViewModelBase
    {
        ...
        private async void OnDeserialized(StreamingContext context)
        {
            ...
            {
                var indexScene = _gameEntities.IndexOf(x);
                RemoveGameEntity(x);
                Project.UndoRedo.Add(new UndoRedoAction(
                    () => _gameEntities.Insert(indexScene, x),
                    () => RemoveGameEntity(x),
                    $"Remove {x.Name}"));
            });
            //SetCommands();

            //Project.UndoCommand = new RelayCommand<object>(x => Project.UndoRedo.Undo());
            //RedoCommand = new RelayCommand<object>(x => Project.UndoRedo.Redo());
